        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">
              Les organisations qui soutiennent la mission de REAAGESS
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {partenaires.map((p, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl shadow-sm p-6 flex gap-4 hover:shadow-md transition-shadow"
              >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${typeColors[p.type] || "bg-gray-100 text-gray-600"}`}
                    >
                      {p.type}
                    </span>
                  </div>
