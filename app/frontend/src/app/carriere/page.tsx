        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">
              Développez votre carrière dans le domaine de la géomatique
              africaine
            </p>
          </div>
            ...
            {opportunities.map((o, i) => {
              ...
              return (
                <Link
                  key={i}
                  href={o.href}
                  className="bg-white rounded-2xl shadow-sm p-8 hover:shadow-md transition-all hover:-translate-y-1 group"
                >
                  <div
                    className={`${o.color} w-14 h-14 rounded-2xl flex items-center justify-center mb-6`}
                  >
